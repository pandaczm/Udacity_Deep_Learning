...
class LSTMGenerater(object):
    def __init__(self, embeddings_size, batch_size, num_unrollings, num_nodes):
...
def LSTM_Session_Run(train_lstmbatcher, valid_lstmbatcher, num_nodes, num_steps, sample_frequency):
    graph = tf.Graph()
    ...
    with graph.as_default():
        lstmgen = LSTMGenerater(batch_size=train_batch_size,embeddings_size=embeddings_size,num_unrollings=num_unrollings, num_nodes=num_nodes)
